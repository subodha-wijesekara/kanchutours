        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Experience the true beauty of Sri Lanka with our expertly crafted tours and holiday packages. Travel made easy, memorable, and safe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-slate-400">123 Galle Road, Colombo 03, Sri Lanka</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary shrink-0" />
                <span className="text-sm text-slate-400">+94 77 123 4567</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary shrink-0" />
                <span className="text-sm text-slate-400">hello@kanchutours.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-4">Subscribe to our newsletter for the latest travel updates and offers.</p>
            <form className="flex">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="bg-primary hover:bg-primary-dark transition-colors px-4 py-2.5 rounded-r-md text-white font-medium"
              >
                Subscribe
              </button>
            </form>
