...
const labelCls = "block text-xs font-black uppercase tracking-[0.2em] text-white/80 mb-2 flex items-center gap-2";
const inputCls  = "w-full bg-white/5 border border-white/15 px-4 py-3 text-white text-base placeholder:text-white/30 focus:outline-none focus:border-primary focus:bg-white/8 transition-colors duration-300";
const selectCls = "w-full bg-[#0d0d0d] border border-white/15 px-4 py-3 text-white text-base focus:outline-none focus:border-primary transition-colors duration-300 appearance-none cursor-pointer";
...
function BookingForm() {
  ...
  if (isSubmitted) {
    return (
      <motion.div
        ...
        className="border border-white/8 p-12 text-center relative"
      >
        ...
        <p className="text-white/50 text-sm leading-relaxed max-w-md mx-auto mb-8">
          Thank you, <span className="text-white font-bold">{formData.name}</span>. We have received your
  ...
  return (
    <motion.form
      ...
      className="border border-white/8 relative"
    >
      {/* Red left accent */}
      ...
      <div className="p-8 md:p-12">
        ...
        {/* Submit */}
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <button type="submit"
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="px-8 lg:px-16 max-w-[1400px] mx-auto pb-24">
        <Suspense fallback={
          <div className="border border-white/8 p-20 text-center text-white/20 text-xs uppercase tracking-widest animate-pulse">
            Loading form...
          </div>
        }>
          <BookingForm />
