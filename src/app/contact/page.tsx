    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="pt-36 pb-12 px-8 lg:px-16 max-w-[1400px] mx-auto">
        ...
        <motion.p
          ...
          className="text-white/40 text-sm tracking-wider max-w-xl"
        >
      ...
      <div className="px-8 lg:px-16 max-w-[1400px] mx-auto pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-1">
          ...
          <motion.div
            ...
            className="lg:col-span-2 border border-white/8 p-8 md:p-10 relative group"
          >
            {/* Left accent bar */}
            <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-primary" />

            <h3 className="text-[10px] font-black uppercase tracking-[0.25em] text-white/40 mb-8">
              Contact Information
            </h3>
              ...
              {contactItems.map(({ icon: Icon, label, lines }, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {lines.map((line, j) => (
                      <p key={j} className="text-white/40 text-sm leading-relaxed">
                        {line}
                      </p>
                    ))}
                  </div>
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              <h4 className="text-[10px] font-black uppercase tracking-[0.25em] text-white/40 mb-5">
                Follow Us
              </h4>
              <div className="flex gap-3">
                ...
                <a
                  href="#"
                  className="w-10 h-10 border border-white/15 hover:border-primary hover:bg-primary flex items-center justify-center text-white/40 hover:text-white transition-all duration-300"
                >
          ...
          <motion.div
            ...
            className="lg:col-span-3 border border-white/8 p-8 md:p-10 relative"
          >
            <h3 className="text-[10px] font-black uppercase tracking-[0.25em] text-white/40 mb-8">
              Send Us a Message
            </h3>
            ...
            {isSent ? (
              <motion.div
                ...
                className="border border-white/15 p-8 text-center"
              >
                ...
                <button
                  ...
                  className="text-xs font-black uppercase tracking-widest text-primary hover:text-white transition-colors flex items-center gap-1 mx-auto"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-xs font-black uppercase tracking-[0.2em] text-white/80 mb-2"
                    >
                      Your Name
                    </label>
                    <input
                      ...
                      required
                      className="w-full bg-white/5 border border-white/15 px-4 py-3 text-white text-base placeholder:text-white/40 focus:outline-none focus:border-primary focus:bg-white/8 transition-colors duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-white/5 border border-white/15 px-4 py-3 text-white text-base placeholder:text-white/40 focus:outline-none focus:border-primary focus:bg-white/8 transition-colors duration-300 resize-none"
